# YouTube MP3-MP4 İndirme Programı - v1.0.12.1

# Python 3.10

# Onur Erikçi

# Başlamadan önce, ffmpeg.exe dosyasının proje konumunda bulunduğundan emin olun. Aksi takdirde dosya dönüştürme işlemi yapılamaz.
...
class Download(QThread):
    ...
    def __init__(self, mw, url, filename, index):
        super(Download, self).__init__(mw)
        self.url = url
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                view = view.replace(',', '.')
                rating = self.current_page #"5 Üzerinden " + f'{self.current_page.rating:.2f}'
                ...
                self.rating_signal.emit(str(rating))
...
class Main(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("YouTube MP3-MP4 İndirme Programı - v1.0.12.1")

        self.youtube_Url = QUrl("https://www.youtube.com")
        ...
        self.author_Label = QLabel("Onur Erikçi")
        ...
        self.statusBar.addWidget(self.author_Label)
        ...
        self.info_Layout.addWidget(self.info_rating_GroupBox)
    ...
    def url_changed(self, url):
        ...
        if url.toString().startswith(key):
            try:
                ...
                self.status_Icon.setPixmap(self.status_Pixmap)
                self.status_Message.setText("Bilgiler yükleniyor...")
            self.info_Thread = Thread(self, url.toString())
            ...
            self.info_Thread.rating_signal.connect(self.get_rating)
    ...
    def disable_right_tab(self):
        ...
        self.info_rating_Label.setText("")
    ...
    def download_button(self):
        ...
        self.download_Thread = Download(self, url, filename, index)
